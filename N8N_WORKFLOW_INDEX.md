...
- **Last verified:** 2026-05-05
- **Naming reconciliation (Tyson, 2026-08-19, verified against the live page):** the "Freedom and Flow Challenge (FFC)" and the "7 Day Automation Challenge" are the SAME asset under two names; this index previously documented them as unrelated. Canonical name going forward: **7 Day Automation Challenge (formerly FFC)**. FSC is the traffic source; the challenge itself is a Flow OS asset (sub-account 2NszMTudEJyVXCzQjNTo).
- **Boundary note (flow-coach-ai):** the challenge's chat assistant, flow-coach-ai (github.com/tysonven/flow-coach-ai, live at flowcoach.flowos.tech since 2026-08-21), touches NO n8n workflow. It posts directly to two GHL workflow webhooks on the Flow OS sub-account (lead + day progress). FSC-side contact bridging is this n8n webhook; challenge-app events go straight to Flow OS GHL.
